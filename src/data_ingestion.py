...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        logger.debug("Data preprocessing is complete")
        return df
...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    """Save the trained and test datasets"""
    try:
...
def main():
    try:
        test_size = 0.2
        data_path = "https://raw.githubusercontent.com/avadhoothublikar/Datasets/refs/heads/main/spam.csv"
